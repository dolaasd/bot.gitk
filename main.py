...
BOT_TOKEN = "8653310180:AAGHscU3wH3VMxttusnsfiOwtr17xHZs_jI"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = [
            ...
            [InlineKeyboardButton(get_text(lang, "support_button"), url='https://t.me/otshelpergift')],
        ]
        ...
        await context.bot.send_photo(
            chat_id,
            photo="https://yandex.ru/images/search?pos=27&from=tabbar&img_url=https%3A%2F%2Fi.playerok.com%2FNQJwKXNfeaWCxYa16ZXr9PU7K3731mL91DkmgdoYDGk%2Fwm%3A0.8%3Asoea%3A5%3A2%3A0.2%2Frs%3Afill%3A0%3A1000%3A0%2Fg%3Ano%2Fquality%3A99%2FczM6Ly9wbGF5ZXJvay8vaW1hZ2VzLzFlZmIxOGVmLTYzNzgtNjIwMC0xZmIwLTYyMzgzMmY5N2JhMS5wbmc.jpg&text=playerok+garant&rpt=simage&lr=8",
    ...
    try:
        ...
        if data == 'menu_from_deal':
                ...
                if buyer_id:
                    ...
                    await context.bot.send_message(
                        ...
                        reply_markup=InlineKeyboardMarkup([
                            ...
                            [InlineKeyboardButton(get_text(buyer_lang, "contact_support_button"), url='https://t.me/ManagerPlayerokGift')]
                        ])
                    )
            ...
            keyboard = [
                ...
                [InlineKeyboardButton(get_text(new_lang, "support_button"), url='https://t.me/ManagerPlayerokGift')],
            ]
            if user_id in ADMIN_ID:
                keyboard.append([InlineKeyboardButton("🔧 Админ-панель", callback_data='admin_panel')])
